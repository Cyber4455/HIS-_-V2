...
def show_login():
    ...
    <div style="text-align: center; padding: 40px 20px;">
        ...
        <h2 style="font-size: 1.4em; color: var(--his-primary); margin-bottom: 10px; font-weight: 400;">
            Health Intelligence System
        </h2>
        <p style="font-size: 1.1em; color: var(--his-text);">
    ...
    with tab3:
        ...
        st.markdown("""
        <div style="background: var(--his-accent-bg); padding: 20px; border-radius: 12px; margin: 20px 0; border: 1px solid var(--his-card-border);">
            ...
            <ul style="color: var(--his-text-muted); font-size: 0.9em;">
