...
def show_landing():
    ...
    <div style="text-align: center; padding: 40px 20px;">
        ...
        <h2 style="font-size: 1.6em; color: var(--his-primary); margin-bottom: 10px; font-weight: 400;">
            Health Intelligence System
        </h2>
        <p style="font-size: 1.2em; color: var(--his-text); max-width: 700px; margin: 0 auto 30px;">
    ...
    st.markdown("<p style='color: var(--his-text-muted); margin-bottom: 20px;'>Choose your role to access the appropriate features and interface.</p>", unsafe_allow_html=True)
    ...
    with col1:
        ...
        <div class="feature-card" style="text-align: center; min-height: 220px;">
            ...
            <h3 style="color: var(--his-primary);">Patient</h3>
            <p style="color: var(--his-text); font-size: 0.9em;">
    ...
    <div class="glass-card">
        ...
        <p style="color: var(--his-text-muted); font-size: 0.9em;">
    ...
    <div style="text-align: center; padding: 20px;">
        <p style="color: var(--his-text-muted); font-size: 1em;">
