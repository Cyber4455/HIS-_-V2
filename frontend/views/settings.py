...
def show_settings():
    ...
    if user_role != "admin" and not is_guest:
        with st.expander("🔐 Admin Access", expanded=False):
            st.markdown("""
            <div style="background: var(--his-accent-bg); padding: 15px; border-radius: 8px; margin: 10px 0; border: 1px solid var(--his-card-border);">
    ...
    st.markdown("""
    <div style="text-align: center; color: var(--his-text-muted); font-size: 0.8em; padding: 20px;">
