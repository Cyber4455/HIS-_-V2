...
def show_sidebar():
    ...
    with st.sidebar:
        ...
        if st.session_state.get("logged_in"):
            ...
            if is_guest:
                st.markdown("<small style='color: var(--his-primary);'>👤 Guest Session</small>", unsafe_allow_html=True)
        st.markdown("---")
        ...
        st.markdown("""
        <div style="font-size: 0.8em; color: var(--his-text-muted); margin-top: 20px;">
